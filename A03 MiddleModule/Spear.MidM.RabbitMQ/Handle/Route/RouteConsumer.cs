...
{
    public class RouteConsumer : RabbitMQHandle<RouteParamResponse>
    {
        protected override void Exec(RouteParamResponse mqParam)
        {
        ...
        protected override void Quit(RouteParamResponse mqParam)
        {
            var arguments = new Dictionary<string, object>();
